...
addpath(genpath('/Volumes/server/Projects/Temporal_integration/DN_2019_code_data/code'))
...
%eltomatch{1} = {'Oc9', 'Oc12','Oc13','Oc17','Oc18','Oc19','Oc20','Oc25','Oc26','Oc27','Oc28'};
%eltomatch{1} = {'MO01', 'MO02'};
%eltomatch{2} = {'OC01'};
eltomatch{1} = a{1}.trials.channels.name(5:7);
...
%deleteme (V1-like parameters from  Jing) --------
%prm = [.1 .08 3 .12  .06  1];
%deleteme ----------------------------------------
