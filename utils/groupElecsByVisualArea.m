...
INX{7} = contains(channels.wangarea, {'LO1', 'LO2'}) | contains(channels.bensonarea, {'LO1', 'LO2'});
INX{8} = contains(channels.wangarea, {'TO1', 'TO2'}) | contains(channels.bensonarea, {'TO1', 'TO2'});
